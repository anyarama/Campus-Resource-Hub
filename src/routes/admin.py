...
def dashboard():
    ...
    try:
        ...
        trends = {
            ...
            "cancelled_bookings": raw_trends["by_status"].get("cancelled", 0)
            + raw_trends["by_status"].get("rejected", 0),
...
def user_detail(user_id):
    ...
    try:
        ...
        return render_template("admin/user_detail.html", user=user, activity=activity)
